...
<body>
    ...
    $sql = "SELECT name, file_path, likes FROM videos ORDER BY likes DESC LIMIT 3"; // Select name and file_path, ordered by views in descending order, limit to 3
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '</video><span class="likes-count"> most populair amongst reviewers ' . $likes . '</span></div></div>';
        }
        echo '</div>';
    } else {
